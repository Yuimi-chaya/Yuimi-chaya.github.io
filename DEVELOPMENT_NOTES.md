...
1. Obtain user visual acceptance for the revised charge-flight launch and U-turn timing; tune only the route shape or overall flight duration if the continuous motion still feels too restrained or too fast.
