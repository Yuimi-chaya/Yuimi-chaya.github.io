...
- Status: implemented and locally validated; user visual acceptance is pending. `d1ffa62` is the rollback point before this work, and `39c76f9` is the latest functional checkpoint.
...
- Generated Blog assets: `public/themes/kisara/assets/blog/engage-kiss-scene.webp`, `kisara-front.webp`, `shu-middle.webp`, `ayano-middle.webp`, and `sharon-back.webp`. `scripts/extract_kisara_blog_layers.py` reproduces the extraction without modifying the source artwork.
