...
- Local state: the Kisara image transition, single-envelope charge beam, jet/coast/drift wake particles, post-gloss procedural warning, segmented foreground pink-black-hole release, side-only WebGL2 background lensing, independent title refraction/dissolve/reconstruction, full-screen block reconstruction, multi-wave aftermath, lingering particle rain, persistent glitch status, and site-wide deep-indigo UI are implemented and browser-validated. The title now combines a clear red core, retained soft tide, and a wider sharp metal blade pass. The black-hole center is a bounded offscreen ball-lightning sphere with moving internal branches, plasma volume, outer tendrils, and a deep moving void. Canvas/WebGL sizing is event-driven, and adaptive particle/shadow quality reduces peak work while restoring a consistent second-cycle baseline. The latest visual refinement is committed locally at `280cd0d` and is not pushed. Untracked user source materials remain separate and untouched (`102000325_p0.jpg`, `122472458_p0.png`, `gate-background.jpg`, `XP/`, `kisara/`, `showcase-output/`).
