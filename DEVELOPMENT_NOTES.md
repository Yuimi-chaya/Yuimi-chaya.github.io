...
- The warning desaturation is now one isolated `mix-blend-mode: saturation` layer above the title and below the burst/impact effects. The former second full-screen `soft-light` blend pass was removed. Existing gate and impact `isolation` boundaries remain intact.
